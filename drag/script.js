...
(async () => {
  ...
  console.log(Alldata);
Alldata["tasks"].forEach(d=>
  {
   
   if( d.username.trim()===userid.trim())
   {
...
function deletetask() {
  ...
  var a = this.parentElement.childNodes[0].childNodes[0].innerHTML;
  a=a.trim();
...
document.getElementById("todo_submit").addEventListener("click", async () => {
  ...
  // delete tempData["dropdown"];
  // delete tempData["am-pm"];
  // delete tempData["24hrs"];
  if(flag)
  {
